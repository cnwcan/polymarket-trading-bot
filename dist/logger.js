...
exports.initHistoryLog = initHistoryLog;
exports.getLogRing = getLogRing;
exports.logToHistory = logToHistory;
exports.logPrintln = logPrintln;
const fs = __importStar(require("fs"));
let historyStream = null;
const LOG_RING_MAX = 500;
const logRing = [];
function initHistoryLog(path = "history.toml") {
    if (historyStream)
        return;
